...
if __name__ == '__main__':
    ...
    argparser.add_argument('--max_dist', type=float, default=0.3,
    ...
    dataloader.parse_by_IBM(config_file=parser_config,
    ...
    with (
        ...
        for line_id, line in tqdm(enumerate(in_f)):
            ...
            writer.writerow(
                (line_id, date, time, pid, level, component, content, event_id,
                 event_template)
            )
